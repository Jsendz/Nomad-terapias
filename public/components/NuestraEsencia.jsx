  ...
  <div id="NuestraEsencia" className="bg-slate-100 xl:h-full w-full">
    ...
    {' '}<span className="font-bold">MÉTODO NOMAD</span>{' '}
     cómo síntesis de un camino de conocimientos.</p>
      ...
      <button onClick={() =>setQuien(!Quien) } className=" border-2 border-gray-700 text-gray-700 p-3 rounded-xl bg-transparent hover:bg-slate-400 animate-bounce">
        + Info
      </button>
      ...
      <button onClick={() =>setTerapia(!Terapia) } className="text-gray-700 p-3 rounded-xl bg-transparent border-2 border-gray-700 animate-bounce">
        + Info
      </button>
