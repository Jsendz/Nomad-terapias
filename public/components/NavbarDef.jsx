    ...
    <Disclosure as="nav" className="bg-transparent absolute w-full">
      {({ open }) => (
        <>
          <div className="max-w-7xl xl:max-w-full h-32 mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-full">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-slate-800 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white animate-pulse">
          ...
          <Disclosure.Panel className="sm:hidden bg-slate-800 rounded-lg">
